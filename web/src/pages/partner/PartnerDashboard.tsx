  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-textPrimary tracking-tight flex items-center gap-2">
            Welcome back, {facility.name} <span className="text-2xl">👋</span>
          </h2>
          <p className="text-textSecondary mt-1">Here's what's happening at your facility today.</p>
        </div>
        <div className="flex items-center gap-3">
          <select className="bg-card border border-border text-textPrimary text-sm rounded-lg px-4 py-2 focus:outline-none focus:border-[#3D91FF] cursor-pointer">
            <option>Today</option>
      ...
      <div className="flex overflow-x-auto md:grid md:grid-cols-2 lg:grid-cols-5 gap-4 pb-2 md:pb-0 hide-scrollbar snap-x">
        ...
        <div 
          ...
          className="snap-start shrink-0 w-[240px] md:w-auto bg-background border border-border hover:border-[#3D91FF]/50 rounded-2xl p-5 cursor-pointer transition-all hover:shadow-[0_0_20px_rgba(61,145,255,0.1)] group"
        >
          <div className="flex justify-between items-start mb-4">
            <p className="text-sm font-medium text-textSecondary group-hover:text-textSecondary transition-colors">Total Appointments</p>
            <div className="w-8 h-8 rounded-full bg-[#3D91FF]/10 flex items-center justify-center text-[#3D91FF]">
              <Calendar size={16} />
            </div>
          </div>
          <h3 className="text-3xl font-bold text-textPrimary mb-2">{totalAppointments}</h3>
          <div className="flex items-center gap-1.5 text-xs">
            <span className="flex items-center text-emerald-400 font-medium"><TrendingUp size={12} className="mr-0.5" /> 18%</span>
            <span className="text-textTertiary">vs yesterday</span>
          </div>
        </div>
        ...
        <div 
          ...
          className="snap-start shrink-0 w-[240px] md:w-auto bg-background border border-border hover:border-[#00C9A7]/50 rounded-2xl p-5 cursor-pointer transition-all hover:shadow-[0_0_20px_rgba(0,201,167,0.1)] group"
        >
          <div className="flex justify-between items-start mb-4">
            <p className="text-sm font-medium text-textSecondary group-hover:text-textSecondary transition-colors">New Patients</p>
            <div className="w-8 h-8 rounded-full bg-[#00C9A7]/10 flex items-center justify-center text-[#00C9A7]">
              <Users size={16} />
            </div>
          </div>
          <h3 className="text-3xl font-bold text-textPrimary mb-2">{newPatients}</h3>
          <div className="flex items-center gap-1.5 text-xs">
        ...
        <div 
          ...
          className="snap-start shrink-0 w-[240px] md:w-auto bg-background border border-border hover:border-[#8B5CF6]/50 rounded-2xl p-5 cursor-pointer transition-all hover:shadow-[0_0_20px_rgba(139,92,246,0.1)] group"
        >
          <div className="flex justify-between items-start mb-4">
            <p className="text-sm font-medium text-textSecondary group-hover:text-textSecondary transition-colors">Today's Revenue</p>
            <div className="w-8 h-8 rounded-full bg-accent-purple flex items-center justify-center text-[#8B5CF6]">
              <DollarSign size={16} />
            </div>
          </div>
          <h3 className="text-3xl font-bold text-textPrimary mb-2">₹{(todayRevenue/1000).toFixed(1)}k</h3>
          <div className="flex items-center gap-1.5 text-xs">
        ...
        <div 
          ...
          className="snap-start shrink-0 w-[240px] md:w-auto bg-background border border-border hover:border-[#F59E0B]/50 rounded-2xl p-5 cursor-pointer transition-all hover:shadow-[0_0_20px_rgba(245,158,11,0.1)] group"
        >
          <div className="flex justify-between items-start mb-4">
            <p className="text-sm font-medium text-textSecondary group-hover:text-textSecondary transition-colors">Pending Orders</p>
            <div className="w-8 h-8 rounded-full bg-[#F59E0B]/10 flex items-center justify-center text-[#F59E0B]">
              <Package size={16} />
            </div>
          </div>
          <h3 className="text-3xl font-bold text-textPrimary mb-2">{pendingOrders}</h3>
        ...
        <div 
          ...
          className="snap-start shrink-0 w-[240px] md:w-auto bg-background border border-red-900/50 hover:border-red-500/50 rounded-2xl p-5 cursor-pointer transition-all hover:shadow-[0_0_20px_rgba(239,68,68,0.1)] group relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-24 h-24 bg-red-500/5 blur-2xl rounded-full"></div>
          <div className="flex justify-between items-start mb-4 relative z-10">
            <p className="text-sm font-medium text-textSecondary group-hover:text-textSecondary transition-colors">Low Stock Items</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-background border border-border rounded-2xl overflow-hidden flex flex-col md:flex-row">
            ...
            <div className="p-6 md:w-2/5 border-b md:border-b-0 md:border-r border-border bg-gradient-to-br from-[#131b2f]/30 to-transparent flex flex-col">
              ...
              <div className="flex-1 flex items-center justify-center relative min-h-[160px]">
                ...
                <div className="relative w-36 h-36">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-2xl font-bold text-textPrimary">{totalAppointments}</span>
                    <span className="text-[10px] text-textSecondary">Total</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 flex flex-col gap-2">
                <div className="flex items-center justify-between text-xs">
                  <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-[#00C9A7]"></div><span className="text-textSecondary">Completed</span></div>
                  <span className="text-textSecondary">53%</span>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-[#3D91FF]"></div><span className="text-textSecondary">Upcoming</span></div>
                  <span className="text-textSecondary">31%</span>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-[#F59E0B]"></div><span className="text-textSecondary">Cancelled</span></div>
                  <span className="text-textSecondary">16%</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 md:w-3/5 flex flex-col">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-base font-bold text-textPrimary">Today's Appointments</h3>
                  ...
                  <div key={apt.id} className="flex items-center justify-between p-3 rounded-xl hover:bg-[#131b2f] transition-colors group">
                    <div className="flex items-center gap-4">
                      <div className="w-12 text-center shrink-0">
                        ...
                        <span className="text-[9px] text-textTertiary font-medium">{apt.time.split(' ')[1]}</span>
                      </div>
                      <div className="w-[2px] h-8 bg-surface group-hover:bg-surface"></div>
                      <div>
                        <p className="text-sm font-bold text-textPrimary">{apt.patientName}</p>
                        <p className="text-[10px] text-textSecondary">{apt.department} • {apt.doctorName}</p>
                      </div>
                    </div>
              ...
              <button onClick={() => navigate('/partner/appointments')} className="w-full mt-4 py-2.5 rounded-xl border border-border hover:border-border hover:bg-surface text-xs font-bold text-textSecondary transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-background border border-border rounded-2xl p-6 flex flex-col">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-base font-bold text-textPrimary">Revenue Overview</h3>
                <select className="bg-transparent text-xs text-textSecondary cursor-pointer focus:outline-none">
                  <option>This Month</option>
                  <option>Last Month</option>
                </select>
              </div>
              <div className="mb-6">
                <h4 className="text-2xl font-bold text-textPrimary mb-1">₹ 24,85,000</h4>
                <div className="flex items-center gap-1.5 text-[10px]">
                  <span className="flex items-center text-emerald-400 font-bold"><TrendingUp size={10} className="mr-0.5" /> 18%</span>
                  <span className="text-textTertiary">vs last month</span>
                </div>
              </div>
              ...
              <div className="flex justify-between text-[9px] text-textTertiary mt-2 font-medium">
                <span>1 May</span>
                <span>8 May</span>
                <span>15 May</span>
                <span>22 May</span>
            ...
            <div className="bg-background border border-border rounded-2xl p-6 flex flex-col">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-base font-bold text-textPrimary">Inventory Status</h3>
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
                      <span className="text-sm font-bold text-textPrimary">Pharmacy Items</span>
                      <span className="text-xs font-medium text-textSecondary">120 Low</span>
                    </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
                      <span className="text-sm font-bold text-textPrimary">Lab Consumables</span>
                      <span className="text-xs font-medium text-textSecondary">36 Low</span>
                    </div>
                    <div className="w-full bg-surface h-1.5 rounded-full overflow-hidden">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
                      <span className="text-sm font-bold text-textPrimary">Equipment</span>
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Notifications Panel */}
          <div className="bg-background border border-border rounded-2xl flex flex-col flex-1">
            <div className="p-5 border-b border-border flex justify-between items-center">
              ...
              <button className="text-[10px] text-textSecondary hover:text-textPrimary transition-colors">Mark all read</button>
            </div>
            <div className="flex-1 p-3 overflow-y-auto max-h-[400px] lg:max-h-none space-y-2">
              {notifications.map(n => (
                <div key={n.id} onClick={() => n.link && navigate(n.link)} className={`p-4 rounded-xl border ${n.read ? 'bg-transparent border-transparent' : 'bg-[#131b2f] border-border hover:border-border cursor-pointer'} transition-colors relative`}>
                  ...
                  <p className="text-[9px] text-textTertiary font-medium flex items-center gap-1"><Clock size={10} /> 10 mins ago</p>
                </div>
              ))}
            </div>
          ...
          <div className="bg-gradient-to-br from-[#8B5CF6]/20 to-[#3D91FF]/10 border border-[#8B5CF6]/30 rounded-2xl p-6 relative overflow-hidden">
             <div className="absolute top-0 right-0 w-32 h-32 bg-accent-purple blur-3xl rounded-full"></div>
             <div className="relative z-10 flex items-start gap-4">
               <div className="w-12 h-12 bg-accent-purple border border-[#8B5CF6]/40 rounded-xl flex items-center justify-center text-[#8B5CF6] shrink-0">
                 <CheckCircle2 size={24} />
               </div>
               <div>
                 <h3 className="text-base font-bold text-textPrimary mb-1">Your Facility is Verified</h3>
                 <p className="text-xs text-textSecondary leading-relaxed mb-4 opacity-80">Thank you for providing excellent service and helping us build a healthier community.</p>
                 <button onClick={() => navigate('/partner/profile')} className="text-xs font-bold text-textPrimary bg-accent-purple hover:bg-accent-purple px-4 py-2 rounded-lg transition-colors">
                   View Profile
                 </button>
               </div>
             </div>
