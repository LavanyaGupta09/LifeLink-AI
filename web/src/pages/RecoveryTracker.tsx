  ...
  return (
    <div className="w-full min-h-screen bg-background text-textPrimary font-sans flex flex-col pb-[120px] px-6 py-6">
      <header className="sticky top-0 z-40 bg-background backdrop-blur-xl border-b border-border px-4 py-4 flex items-center gap-4 -mx-6 px-6 mb-6">
        <button className="w-10 h-10 rounded-full bg-surface flex items-center justify-center text-textPrimary active:scale-95 transition-transform" onClick={() => navigate('/physiotherapy')}>
          <ArrowLeft size={20} />
        </button>
        <div>
      ...
      <div className="flex-1 flex flex-col gap-6">
        ...
        <div className="bg-gradient-to-br from-[#131F35] to-[#1E1B4B] border border-amber-500/20 rounded-3xl p-6 shadow-xl relative overflow-hidden">
          <div className="flex justify-between items-end mb-6">
            <div>
              <h2 className="text-3xl font-black text-textPrimary">80%</h2>
          ...
          <p className="text-xs text-textSecondary text-right">Target: 100% by Oct 15</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-3xl p-6 shadow-xl">
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col items-center">
              <div className="w-14 h-14 rounded-full border-4 border-rose-500/50 flex items-center justify-center text-xl font-black text-textPrimary mb-2 bg-rose-500/10">7</div>
              <span className="text-xs text-textSecondary font-medium">Session 1</span>
            </div>
            
            <div className="flex-1 h-[2px] bg-gradient-to-r from-rose-500/50 to-emerald-400/50 mx-4 relative">
              <ChevronRight size={16} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-textTertiary" />
            </div>
        ...
        <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-3xl p-5 shadow-xl flex items-center justify-between">
          <div>
            ...
            <p className="font-bold text-lg text-textPrimary">Tomorrow • 6:00 PM</p>
            <p className="text-xs text-textSecondary">Dr. Priya Sharma (Home Visit)</p>
          </div>
        ...
        {/* Milestone Checklist */}
        <div className="bg-card border border-border rounded-3xl p-6 shadow-xl">
          <h3 className="font-bold text-textPrimary mb-4">Treatment Milestones</h3>
          
          <div className="flex flex-col gap-4">
            <div className="flex gap-3">
              <CheckCircle2 size={24} className="text-emerald-400 flex-shrink-0" />
              <div>
                <p className="font-bold text-textPrimary text-sm line-through opacity-70">Session 1: Initial Assessment</p>
                <p className="text-xs text-textTertiary">Completed on 10 Aug</p>
              </div>
            </div>
            <div className="flex gap-3">
              <CheckCircle2 size={24} className="text-emerald-400 flex-shrink-0" />
              <div>
                <p className="font-bold text-textPrimary text-sm line-through opacity-70">Session 2: Passive Range of Motion</p>
                <p className="text-xs text-textTertiary">Completed on 12 Aug</p>
              </div>
            </div>
            <div className="flex gap-3">
              <CheckCircle2 size={24} className="text-emerald-400 flex-shrink-0" />
              <div>
                <p className="font-bold text-textPrimary text-sm line-through opacity-70">Session 3: Strengthening Starts</p>
                <p className="text-xs text-textTertiary">Completed on 14 Aug</p>
              </div>
            </div>
            <div className="flex gap-3">
              <Circle size={24} className="text-textTertiary flex-shrink-0" />
              <div>
                <p className="font-bold text-textPrimary text-sm">Session 4: Balance & Core</p>
            ...
            <div className="flex gap-3 opacity-50">
              <Circle size={24} className="text-textTertiary flex-shrink-0" />
              <div>
                <p className="font-bold text-textPrimary text-sm">Session 5: Full Weight Bearing</p>
                <p className="text-xs text-textTertiary">Pending</p>
              </div>
            </div>
          </div>
        </div>
