  ...
  return (
    <div className="p-4 md:p-8 pb-24 w-full">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-textPrimary">Doctor Dashboard</h1>
        <button onClick={handleLogout} className="px-4 py-2 bg-rose-500/10 text-rose-400 border border-rose-500/30 rounded-xl hover:bg-rose-500 hover:text-textPrimary font-bold transition text-sm flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        {/* Stat 1 */}
        <div className="bg-card border border-border rounded-2xl p-6 relative overflow-hidden group hover:border-emerald-500/50 transition-all cursor-default">
          <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/5 rounded-full -mr-10 -mt-10 blur-2xl"></div>
          <p className="text-sm text-textSecondary font-medium mb-1 relative z-10">Today's Consultations</p>
          <div className="flex items-end justify-between relative z-10">
            <h3 className="text-3xl font-black text-textPrimary">18</h3>
        ...
        >
          ...
          <div className="flex items-end justify-between relative z-10">
            <h3 className="text-3xl font-black text-textPrimary">3</h3>
        ...
        {/* Stat 3 */}
        <div className="bg-card border border-border rounded-2xl p-6 relative overflow-hidden group hover:border-blue-500/50 transition-all cursor-default">
          <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/5 rounded-full -mr-10 -mt-10 blur-2xl"></div>
          <p className="text-sm text-textSecondary font-medium mb-1 relative z-10">Today's Earnings</p>
          <div className="flex items-end justify-between relative z-10">
            <h3 className="text-3xl font-black text-textPrimary">₹ 8,450</h3>
            <div className="flex flex-col items-end">
        ...
        {/* Stat 4 */}
        <div className="bg-card border border-border rounded-2xl p-6 relative overflow-hidden group hover:border-amber-500/50 transition-all cursor-default">
          <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/5 rounded-full -mr-10 -mt-10 blur-2xl"></div>
          <p className="text-sm text-textSecondary font-medium mb-1 relative z-10">Total Patients</p>
          <div className="flex items-end justify-between relative z-10">
            <h3 className="text-3xl font-black text-textPrimary">1,245</h3>
          ...
          <div className="bg-card border border-border rounded-3xl p-6 flex flex-col">
            ...
            <div className="flex-1 custom-scrollbar pr-2 space-y-4 relative">
              {[
                ...
                <div key={i} className="flex items-center justify-between bg-background p-4 rounded-xl border border-border hover:border-border transition-colors">
                  <div className="flex items-center gap-4">
                    <img src={`https://i.pravatar.cc/100?img=${i + 20}`} alt={patient.name} className="w-12 h-12 rounded-full object-cover border border-border" />
                    <div>
                      <h4 className="text-textPrimary font-bold">{patient.name}</h4>
                      <p className="text-textSecondary text-xs">{patient.age} • {patient.gender}</p>
                    </div>
                  </div>
                  
                  <div className="hidden sm:block">
                    <p className="text-textSecondary text-sm font-medium">{patient.symptoms}</p>
            ...
            <button onClick={() => navigate('/doctor/on-call')} className="w-full mt-4 py-3 bg-surface hover:bg-surface text-emerald-400 font-bold rounded-xl flex items-center justify-center gap-2 transition-colors text-sm">
        ...
        <div className="xl:col-span-1 space-y-6">
          ...
          <div className="bg-card border border-border rounded-3xl p-6 flex flex-col">
            ...
            <div className="flex-1 custom-scrollbar pr-2 relative">
               <div className="absolute left-6 top-0 bottom-0 w-px bg-surface"></div>
                 ...
                 <div key={i} className="flex gap-4 mb-6 relative">
                   ...
                   <div className="flex-1 bg-background p-3 rounded-xl border border-border">
                     <div className="flex justify-between items-start">
                       ...
                       <span className={`text-[10px] font-bold px-2 py-0.5 rounded ${apt.status === 'Completed' ? 'bg-surface text-textSecondary' : 'bg-blue-500/20 text-blue-400'}`}>
                         {apt.status}
                       </span>
                     </div>
                     <p className="text-textTertiary text-xs mt-1">{apt.type}</p>
                   </div>
                 </div>
               ))}
            </div>

            <button onClick={() => navigate('/doctor/scheduled')} className="w-full mt-2 py-2 text-textSecondary hover:text-textPrimary text-xs font-bold flex items-center justify-center gap-1 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-card border border-border rounded-3xl p-6">
           <div className="flex justify-between items-center mb-6">
             <h3 className="font-bold text-textPrimary">Patient Overview</h3>
             <select className="bg-transparent text-xs text-textSecondary outline-none cursor-pointer">
           ...
           <div className="flex flex-col sm:flex-row items-center sm:items-start md:items-center gap-6">
             <div className="relative w-28 h-28 shrink-0 flex items-center justify-center">
               ...
               <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                 <span className="text-xl font-black text-textPrimary leading-none">248</span>
                 <span className="text-[10px] text-textSecondary font-bold uppercase">Total</span>
               </div>
             </div>
             <div className="flex-1 space-y-3">
               <div>
                 <div className="flex items-center gap-2 mb-1">
                   ...
                   <span className="text-xs text-textSecondary">New Patients</span>
                 </div>
                 <p className="text-sm font-bold text-textPrimary pl-4">128 (52%)</p>
               </div>
               <div>
                 <div className="flex items-center gap-2 mb-1">
                   <div className="w-2 h-2 rounded-full bg-blue-500"></div>
                   <span className="text-xs text-textSecondary">Returning Patients</span>
                 </div>
                 <p className="text-sm font-bold text-textPrimary pl-4">96 (39%)</p>
               </div>
               <div>
                 <div className="flex items-center gap-2 mb-1">
                   <div className="w-2 h-2 rounded-full bg-amber-500"></div>
                   <span className="text-xs text-textSecondary">Follow-ups</span>
                 </div>
                 <p className="text-sm font-bold text-textPrimary pl-4">24 (9%)</p>
               </div>
             </div>
           </div>
        </div>
        ...
        <div className="bg-card border border-border rounded-3xl p-6">
           <div className="flex justify-between items-center mb-6">
             <h3 className="font-bold text-textPrimary">Recent Reviews</h3>
             ...
             <div className="border-b border-border pb-4">
               <div className="flex justify-between items-start mb-2">
                 <div className="flex gap-3">
                   <img src="https://i.pravatar.cc/100?img=5" alt="user" className="w-8 h-8 rounded-full border border-border" />
                   <div>
                     <h4 className="text-textPrimary font-bold text-sm leading-none">Pooja Mehta</h4>
                     <div className="flex text-amber-500 text-[10px] mt-1">
                       ...
                       <Star size={10} fill="currentColor"/>
                       <Star size={10} fill="currentColor"/>
                       <span className="text-textSecondary ml-1">5.0</span>
                     </div>
                   </div>
                 </div>
               </div>
               <p className="text-textSecondary text-xs line-clamp-2">"Very helpful and explained everything clearly. Thank you doctor!"</p>
               <p className="text-[10px] text-textTertiary mt-2 text-right">2 days ago</p>
             </div>
             <div>
               <div className="flex justify-between items-start mb-2">
                 <div className="flex gap-3">
                   <img src="https://i.pravatar.cc/100?img=8" alt="user" className="w-8 h-8 rounded-full border border-border" />
                   <div>
                     <h4 className="text-textPrimary font-bold text-sm leading-none">Arjun Singh</h4>
                     <div className="flex text-amber-500 text-[10px] mt-1">
                       <Star size={10} fill="currentColor"/>
                       <Star size={10} fill="currentColor"/>
                       <Star size={10} fill="currentColor"/>
               ...
               <p className="text-textSecondary text-xs line-clamp-2">"Great experience, very professional and kind."</p>
               <p className="text-[10px] text-textTertiary mt-2 text-right">5 days ago</p>
             </div>
           </div>
        </div>
        ...
        {/* Quick Actions */}
        <div className="bg-card border border-border rounded-3xl p-6">
           <h3 className="font-bold text-textPrimary mb-6">Quick Actions</h3>
           
           <div className="grid grid-cols-2 gap-4">
             <button onClick={() => navigate('/doctor/prescriptions')} className="bg-background hover:bg-surface border border-border rounded-2xl p-4 flex flex-col items-center justify-center text-center transition-colors group">
               ...
               <span className="text-textPrimary font-bold text-xs">Create<br/>Prescription</span>
             </button>
             
             <button onClick={() => navigate('/doctor/medical-records')} className="bg-background hover:bg-surface border border-border rounded-2xl p-4 flex flex-col items-center justify-center text-center transition-colors group">
               ...
               <span className="text-textPrimary font-bold text-xs">Upload<br/>Report</span>
             </button>

             <button onClick={() => navigate('/doctor/patients')} className="bg-background hover:bg-surface border border-border rounded-2xl p-4 flex flex-col items-center justify-center text-center transition-colors group">
               ...
               <span className="text-textPrimary font-bold text-xs">Patient<br/>Directory</span>
             </button>

             <button onClick={() => navigate('/doctor/settings')} className="bg-background hover:bg-surface border border-border rounded-2xl p-4 flex flex-col items-center justify-center text-center transition-colors group">
               ...
               <span className="text-textPrimary font-bold text-xs">Update<br/>Availability</span>
             </button>
           </div>
        </div>
