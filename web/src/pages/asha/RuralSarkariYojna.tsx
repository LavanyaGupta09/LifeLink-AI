    ...
    <div className="min-h-screen bg-[#0B1121] text-white flex flex-col items-center pb-24">
      <div className="w-full max-w-md p-4 flex flex-col gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-white">Sarkari Yojna</h1>
        </div>

        <p className="text-slate-300 text-sm">Sarkari swasthya yojna ke baare me janiye.</p>

        {/* Schemes List */}
        <div className="flex flex-col gap-4">
          {schemes.map((s, i) => (
            <div key={i} className="bg-[#131F35] border border-indigo-500/30 rounded-2xl p-4 flex flex-col gap-3">
              ...
              <div className="bg-[#0B1121] rounded-lg p-3 text-xs border border-slate-800 flex items-start gap-2">
                <CheckCircle size={14} className="text-emerald-400 mt-0.5 shrink-0" />
                <div>
                  <span className="font-bold text-emerald-400">Kya milega?</span>
                  <p className="text-slate-300 mt-1">{s.benefit}</p>
                </div>
              </div>
              ...
              <div className="bg-[#0B1121] rounded-lg p-3 text-xs border border-slate-800 flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-slate-300 mt-1">{s.eligibility}</p>
                </div>
              </div>

              <div className="bg-[#0B1121] rounded-lg p-3 text-xs border border-slate-800">
                <span className="font-bold text-slate-400 flex items-center gap-1 mb-1">Kaunse kagaz chahiye? (Documents)</span>
