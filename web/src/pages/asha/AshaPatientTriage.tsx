    ...
    <div className="w-full min-h-screen bg-[#040814] text-white pb-32">
      ...
      <div className="w-full px-4 py-4 flex items-center gap-3 sticky top-0 bg-[#040814]/95 backdrop-blur-sm z-30 border-b border-slate-800/50">
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-400">Toll-free number par call karein</p>
        </div>
      </div>
      ...
      <div className="px-4 py-6 max-w-lg mx-auto">
        ...
        {/* Symptoms Section */}
        <div className="mb-4">
          <h3 className="text-base font-bold mb-3 text-slate-200">Kis liye call karein?</h3>
          
          <div className="flex flex-col gap-3">
            {symptoms.map((s, i) => (
              <div
                key={i}
                className="bg-[#0B1221] border border-slate-800 rounded-xl p-4 flex items-center gap-4 hover:border-slate-600 transition-colors"
              >
        ...
        {/* Info Note */}
        <div className="bg-[#131F35] border border-slate-800 rounded-xl p-4 text-center">
          <p className="text-xs text-slate-400 leading-relaxed">
            📞 Yeh number bilkul <strong className="text-white">muft</strong> hai.<br />
